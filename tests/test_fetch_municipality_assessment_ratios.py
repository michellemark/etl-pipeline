...
from etl.fetch_municipality_assessment_ratios import check_if_county_assessment_ratio_exists
from etl.fetch_municipality_assessment_ratios import fetch_county_assessment_ratios
...
def test_check_if_county_assessment_ratio_exists_no_matching_record():
    ...
    with patch("etl.fetch_municipality_assessment_ratios.execute_db_query", return_value=mocked_query_result):
...
def test_fetch_county_assessment_ratios_success():
    ...
    with patch("etl.fetch_municipality_assessment_ratios.custom_logger") as mock_custom_logger, \
        patch("etl.fetch_municipality_assessment_ratios.Socrata") as mock_socrata_client:
        app_token = "app_token"
        rate_year = 2024
        county_name = "Cayuga"
        mock_response = [
...
def test_fetch_municipality_assessment_ratios_data_already_exists():
    ...
    with patch("etl.fetch_municipality_assessment_ratios.custom_logger") as mock_logger, \
        patch("etl.fetch_municipality_assessment_ratios.fetch_county_assessment_ratios") as mock_fetch_county_ratios, \
        patch("etl.fetch_municipality_assessment_ratios.check_if_county_assessment_ratio_exists") as mock_check_exists:
...
def test_save_all_valid_ratios():
    ...
    with patch("etl.fetch_municipality_assessment_ratios.insert_into_database") as mock_db, \
        patch("etl.fetch_municipality_assessment_ratios.custom_logger") as mock_logger:
...
def test_save_none_ratios():
    ...
    with patch("etl.fetch_municipality_assessment_ratios.custom_logger") as mock_logger, \
        patch("etl.fetch_municipality_assessment_ratios.insert_into_database") as mock_db:
